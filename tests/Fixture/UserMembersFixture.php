 ...
 *
 */
class UserMembersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'confirm_email' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
...
'engine' => 'InnoDB', 'collation' => 'utf8_persian_ci'
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'hidden' => 1,
            'created' => '2015-02-23 10:01:32',
            'modified' => '2015-02-23 10:01:32'
        ],
    ];
}
